...
SCHEMA = {
    "type": "PPMS_4probe",
    "name": r"PPMS 四端子法 (超伝導 $R-T$, $T_\mathrm{c}$, $H_\mathrm{c2}$)",
    "description": r"PPMS 四端子電気抵抗率 ($R-T$, $\rho-T$) 測定、超伝導転移温度 ($T_\mathrm{c}$) 解析",
    "fields": [
        {
            "name": "excitation_current_ua",
            "label": r"励起電流 $I$ [$\mu\mathrm{A}$]",
            "type": "number",
            "default": 100.0,
            "required": True,
        },
        ...
        {
            "name": "tc_onset_k",
            "label": r"超伝導転移開始温度 $T_\mathrm{c}^\mathrm{onset}$ [K]",
            "type": "number",
            "default": 0.0,
            "required": False,
        },
        {
            "name": "tc_zero_k",
            "label": r"ゼロ抵抗温度 $T_\mathrm{c}^\mathrm{zero}$ [K]",
            "type": "number",
            "default": 0.0,
            "required": False,
        },
        {
            "name": "rrr_ratio",
            "label": r"残留抵抗比 RRR ($R_\mathrm{300K} / R_{T_\mathrm{c}}$)",
            "type": "number",
            "default": 1.0,
            "required": False,
        },
