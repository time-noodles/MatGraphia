...
def render():
    ...
    if active_step in ["全項目を表示 (1ページ統合)", "1. 基本情報 ＆ CIF・3D構造"]:
        with st.container():
    ...
    # 2. 物性パラメータ ＆ 不純物相・多形
    if active_step in ["全項目を表示 (1ページ統合)", "2. 物性パラメータ ＆ 不純物相・多形"]:
        with st.container():
            st.subheader("2. 物性パラメータ ＆ 不纯物相・多形")
    ...
    # 3. 関連文献 ＆ 登録実行
    if active_step in ["全項目を表示 (1ページ統合)", "3. 関連文献 ＆ 登録実行"]:
        with st.container():
