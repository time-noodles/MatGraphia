...
from ui.helpers import (
    ...
    build_sample_label,build_literature_label,build_event_label
)
...
def render():
    ...
    for s in samples:
        ...
        if search_q and search_q.lower() not in label.lower():
            continue
    ...
    # 重要: ウィジェット生成前に session_state を更新する
        ...
        if st.button("イベントを登録する"):
            ...
            try:
                evt=Event(
                    ...
                    target_material=target_material,
                    event_type=event_type,
                    input_sample_id=selected_sample_ids[0] if selected_sample_ids else None,
                    reference_event_id=selected_event_ids[0] if selected_event_ids else None,
